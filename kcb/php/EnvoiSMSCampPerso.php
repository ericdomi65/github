...
if( $Numerreurinconnue >0)	{
	...
	if($Numefface > 0)
				{
$message = " Erreur:Des messages non délivrés pour une ou plusieurs raisons (ex:destination invalide): message ou numéro invalide($Numefface messages)";

				}
echo " doc.writeln(\"$message\");\n";
echo "</script>";
 //Ligne 408
